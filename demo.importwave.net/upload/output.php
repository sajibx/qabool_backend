...
document.getElementById("information").innerHTML="' . ($row + 1) . ' / ' . $end_c . ' rows processed.";
 ...
 ///////////////////////////////progress bar code ends here////////////////////////       
		                  ...
		                  //  $TOTAL_AMOUNT       = number_format((float)$row['TOTAL_AMOUNT'], 2, '.', '');
                            ...
                            if (strpos($CTN_NO, 'RMB') !== false || strpos($CTN_NO, 'PICKUP') !== false) {
                                $DEL = 'Y';
                            } else {
                                $DEL = 'N';
                            }
...
(`SN`, `SHIPMENT`, `CTN_NO`, `CTN`, `P.WT`, `CLIENT`, `SHIPPING_MARK`, `ITEM_LIST`, `WEIGHT`, `UNIT_PRICE`, `TOTAL_AMOUNT`, `STATUS`, `DELIVERY`, `DEL_DATE`, `DEL_USER`) VALUES 
(NULL, '$SHIPMENT', '$CTN_NO', '$CTN', '$PWT', '$CLIENT', '$SHIPPING_MARK', '$ITEM_LIST', '$WEIGHT', '$UNIT_PRICE', $PWT*$UNIT_PRICE, 'N', '$DEL', null, null);";
...
if($value1 > 0){
    ...
    $sql_copy = "INSERT INTO `packinglist`
                    SELECT 'NULL', `SHIPMENT`, `CTN_NO`, `CTN`, `P.WT`, `CLIENT`, `SHIPPING_MARK`, `ITEM_LIST`, `WEIGHT`, `UNIT_PRICE`, `TOTAL_AMOUNT`, `STATUS`, `DELIVERY`, `DEL_DATE`, `DEL_USER` FROM `packinglist_temp`";
