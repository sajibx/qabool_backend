...
<div style="height: 35px; width: 100%; border: 0px solid red;">
  <div style="min-width: 100%; border:0px solid black; float: right; margin-bottom: 10px;">
    ...
    <span id="LedTitle" style="font-size: 26; color: 990000; letter-spacing: 5px; float: left; font-weight:bold ;">EXPENSE LEDGER</span>
...
function LoadExp(D1, D2, TYPEx){
    ...
    <img onclick="GetPage('ExpenseLedger');" src='./images/reload.png' style='cursor: hand; width: 33px; float: right;
...
<?php include ("./ExpLedgerTable.php"); ?>
