...
if($CurDate == $date && $TYPE == "D"){
    ...
    $sqlY = "SELECT `sn`, `CashIH` from `Daily3xp_cn` WHERE `date` < '$date' ORDER BY `sn` DESC LIMIT 1;";

    $resultY = $conn->query($sqlY);
    $CashIH = 0; // Default value
    if ($resultY && $resultY->num_rows > 0) {
...
<div style="width:100%; min-height:100px; border:0px solid black;">

<div style="width:100%; height: 30px; border: 0px solid red;">
    <div style="min-width:180px; height: 30px; border: 0px solid red; float: left;">
    ...
    <div style="width:180px; height: 30px; border: 0px solid green; float: right; text-align: right;">
